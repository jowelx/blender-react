...
Command: npx gltfjsx@6.1.4 ../public/AnimacionPelada.gltf
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/AnimacionPelada.gltf')
  return (
    <group {...props} dispose={null} rotation={[0,-20,0]} scale={[0.2,0.2,0.2]}position={[0,-1,0]}>
...
useGLTF.preload('/AnimacionPelada.gltf')
